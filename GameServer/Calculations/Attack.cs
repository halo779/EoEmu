...
namespace GameServer.Calculations
{
    ...
    public partial class Calculation
    {
        public static void Attack(ClientSocket CSocket)
        {
            ...
            CSocket.Send(ConquerPacket.Chat(0, "SYSTEM", CSocket.Client.Name, "Max: " + CSocket.Client.MaxAttack + " Min: " + CSocket.Client.MinAttack + " Magic: " + CSocket.Client.MagicAttack + " / " + CSocket.Client.BonusMagicAttack + " Defense: " + CSocket.Client.Defense + " Bless: " + CSocket.Client.Bless + "% Dodge: " + CSocket.Client.Dodge + " % MaxHP/MP: " + CSocket.Client.MaxHP + "/" + CSocket.Client.MaxMP, Struct.ChatType.Center));
        }
    }
}
